...
_MOCK_TEMPLATES = [
    {
        "id": "standard-3-node",
        "name": "Khung 3 phần chuẩn (K-12)",
        "description": "Template chuẩn cho học sinh trung học. Tập trung vào tiếp thu kiến thức và thực hành cơ bản trong 45-90 phút.",
        "tags": ["chuẩn", "3 phần", "45-90p"],
        "suitable_for": {
            "duration_min": 45,
            "duration_max": 90,
            "bloom_levels": ["NB", "TH"],
        ...
        "nodes": [
            {
                "node_type": "Khởi động",
                "goal": "Kích hoạt kiến thức nền và tạo hứng thú cho học sinh",
                "suggested_duration_pct": 0.20,
            },
            {
                "node_type": "Hình thành kiến thức",
                "goal": "Giới thiệu, giải thích và xây dựng các khái niệm, kiến thức mới cốt lõi",
                "suggested_duration_pct": 0.45,
            },
            {
                "node_type": "Luyện tập",
                "goal": "Học sinh thực hành, làm các bài tập củng cố ngay tại lớp",
    ...
    {
        "id": "extended-4-node",
        "name": "Khung 4 phần mở rộng (K-12)",
        "description": "Dành cho các tiết học kéo dài hoặc yêu cầu ứng dụng thực tiễn cao. Bổ sung hoạt động vận dụng thực tế.",
        "tags": ["mở rộng", "4 phần", "90p+"],
        "suitable_for": {
            "duration_min": 60,
            "duration_max": 180,
        ...
        "nodes": [
            ...
            {
                "node_type": "Hình thành kiến thức",
                "goal": "Giới thiệu và phân tích sâu các khái niệm, kiến thức cốt lõi mới",
                "suggested_duration_pct": 0.35,
            },
            {
                "node_type": "Luyện tập",
                "goal": "Học sinh áp dụng kiến thức trực tiếp vào bài tập củng cố",
                "suggested_duration_pct": 0.30,
            },
            {
                "node_type": "Vận dụng",
                "goal": "Học sinh vận dụng kiến thức đã học để giải quyết vấn đề thực tế hoặc tình huống mở rộng",
                "suggested_duration_pct": 0.20,
            },
        ],
        "rag_activities": [
