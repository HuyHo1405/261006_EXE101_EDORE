...
export function IdeasFlowIllustration({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="800"
      height="545.58"
      viewBox="0 0 800 545.58"
      ...
      <g transform="translate(-207.523 -134.108)">
        <g transform="translate(207.523 134.108)">
          <path
            ...
            transform="translate(-265.352 -389.662)"
            fill="#090814"
          />
          <path
            ...
            transform="translate(-267.009 -287.697)"
            fill="#090814"
          />
          <path
            ...
            transform="translate(-207.046 -304.874)"
            fill="#090814"
          />
          <path
            ...
            transform="translate(-311.667 -313.696)"
            fill="#090814"
          />
          <path
            d="M313.7,624.3c-54.554-24.2-96.592-55.586-118.369-88.389l1.209-.8c21.627,32.578,63.444,63.781,117.747,87.866Z"
            transform="translate(-176.662 -377.825)"
            fill="#090814"
          />
          <circle cx="9.333" cy="9.333" r="9.333" transform="translate(354.954 237.353)" fill="#e6e6e6" />
          <path d="M441.405,597.806l-.143-.024a3.9,3.9,0,0,0,.566-.426Z" transform="translate(-277.54 -394.516)" fill="#fff" />
          <path d="M910.1,361.806l.143-.024a3.9,3.9,0,0,1-.566-.426Z" transform="translate(-461.19 -301.988)" fill="#fff" />
          <path d="M343.405,294.806l-.143-.024a3.9,3.9,0,0,0,.566-.426Z" transform="translate(-239.119 -275.72)" fill="#fff" />
          ...
          <g transform="translate(383.897 90.138)">
            ...
            <g transform="translate(33.284 9.495) rotate(8)">
              ...
              <path
                ...
                fill="#010001"
              />
              <path d="M6.7,19.229H6.351V13.6L0,.147.312,0,6.7,13.516Z" transform="translate(9.763 28.467)" fill="#0f0f10" />
              <path d="M.163.029c.7-.479.716,5.14.5,5.323C-.159,6.044-.073.19.163.029Z" transform="translate(18.383 0)" fill="#f2f2f2" />
              <path d="M.029.017C.584-.34,1.859,4.981,1.777,5.256,1.307,6.823-.23.184.029.017Z" transform="translate(12.86 0.511)" fill="#f2f2f2" />
              <path d="M1.074,0c.66-.174-.451,5-.582,5.24C-.754,7.513.717.1,1.074,0Z" transform="translate(23.126 0.524)" fill="#f2f2f2" />
              <path d="M.283,20.141,0,13.882l.006-.024L3.377,0l.335.082L.347,13.916l.28,6.21Z" transform="translate(21.543 27.563)" fill="#0f0f10" />
            </g>
          </g>
          <circle cx="9.333" cy="9.333" r="9.333" transform="translate(333.842 58.055)" fill="#e6e6e6" />
          <circle cx="9.333" cy="9.333" r="9.333" transform="translate(253.958 60.608)" fill="var(--color-secondary-500, #f28c0f)" />
          <circle cx="9.333" cy="9.333" r="9.333" transform="translate(84.849 174.055)" fill="var(--color-secondary-500, #f28c0f)" />
        ...
        <g transform="translate(662.258 219.931)">
          <path
            ...
            transform="translate(115.084 -139.576)"
            fill="var(--color-secondary-500, #f28c0f)"
          />
          <path
            d="M197.526,287.148l31.689,108.324A23.752,23.752,0,0,1,208.49,425.8l-34.579,3.027,23.616-141.681h0Z"
          ...
          <path
            ...
            transform="translate(-101.25 -73.372)"
            fill="#ed9da0"
          />
          <path
            ...
            transform="translate(-184.781 -125.132)"
            fill="var(--color-secondary-500, #f28c0f)"
          />
          <path
            ...
            transform="translate(-48.383 -66.9)"
            fill="#010102"
          />
          <ellipse cx="34.041" cy="34.041" rx="34.041" ry="34.041" transform="translate(245.565 89.504)" fill="#010102" />
        </g>
      </g>
    </svg>
  );
