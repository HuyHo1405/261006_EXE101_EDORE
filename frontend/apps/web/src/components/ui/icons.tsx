...
export function EyeOff({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M17.479 17.499A10.75 10.75 0 0 1 2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 2.725-3.6" />
...
export function PlayCircle({ className, ...props }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
...
export function CornerDownRight({ className, ...props }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
...
export function ArrowDownRight({ className, ...props }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
