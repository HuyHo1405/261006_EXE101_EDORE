 ...
 *
 * Props:
 *   onFileSelected(file) → advance with selected File object
 *   onManualSubmit(text) → advance with manual text string
 */
export default function ContentInput({ onFileSelected, onManualSubmit }) {
  ...
  return (
    <div className="grid grid-cols-12 gap-8 animate-fade-slide-up">
      {/* Left sidebar: info */}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              {[
                ...
                { icon: 'account_tree', label: 'Map → Bài học 3 nodes' },
                { icon: 'bolt', label: 'Enrich song song' },
              ].map(({ icon, label }, i) => (
